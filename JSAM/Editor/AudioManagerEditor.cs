...
namespace JSAM
{
    ...
    public class AudioManagerEditor : Editor
    {
        ...
        public static string GenerateEnumFile(string filePath, bool usingInstancedEnums)
        {
            ...
            string fileName = (usingInstancedEnums) ? Path.DirectorySeparatorChar + "AudioEnums - " + sceneName + ".cs" : Path.DirectorySeparatorChar + "AudioEnums.cs";
            ...
            foreach (var p in GUIDs)
            {
                ...
                string assetName = Path.DirectorySeparatorChar + assetPath.Remove(0, assetPath.LastIndexOf(Path.DirectorySeparatorChar) + 1);
